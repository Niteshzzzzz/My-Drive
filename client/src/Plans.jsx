...
const PLAN_CATALOG = {
  monthly: [
    {
      // id: "plan_STsLJAkTnaAOA2",
      id: "plan_SVNg2EwrKQ61b8",
      name: "Starter",
    ...
    {
      // id: "plan_STsPfA7VHZtoAX",
      id: "plan_SVNiLJooWlNyNQ",
      name: "Pro",
    ...
    {
      // id: "plan_STsSOjNpKTiDNA",
      id: "plan_SVNkDkEC9XxaK0",
      name: "Ultimate",
  ...
  yearly: [
    {
      // id: "plan_STsWxmSg5Of5HW",
      id: "plan_SVNhRTZaYAYQMm",
      name: "Starter",
      tagline: "Great for individuals",
      storage: "2 TB",
      price: 1999,
    ...
    {
      // id: "plan_STsVVdkkYwQrz2",
      id: "plan_SVNj9OTywU6rQI",
      name: "Pro",
      tagline: "For creators & devs",
      storage: "5 TB",
      price: 3999,
    ...
    {
      // id: "plan_STsUDR44bMFBNy",
      id: "plan_SVNktfMJcZ0unt",
      name: "Ultimate",
      tagline: "Teams & power users",
      storage: "10 TB",
      price: 6999,
...
export default function Plans() {
  ...
  useEffect(()=> {
    const razprpayScript = document.querySelector('#razorpay_script');
    if(razprpayScript) return;
...
function openRazorpayPopup({ subscriptionId }) {
  const rzp = new Razorpay({
    ...
    image: "http://localhost:5173/vite.svg",
    // notes: {
    //   courseId: course.id,
